...
class FFNParser(HTMLParser):
    ...
    def getReplacement(self, origin, url):
        ...
        coverFrameStyle.addStyle("background", COVER_FRAME_COLOR)
        coverFrameStyle.addStyle("border-radius", "{}px".format(COVER_FRAME_RADIUS))
        coverFrameStyle.addStyle("padding", "{}px".format(COVER_FRAME_PADDING))
        ...
        coverFrame.appendChild(coverContainer)
